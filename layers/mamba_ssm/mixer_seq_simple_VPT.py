...
from layers.mamba_ssm.mamba2_dropout import Mamba2
from mamba_ssm.modules.mha import MHA
from mamba_ssm.modules.mlp import GatedMLP
from layers.mamba_ssm.modules.block import Block
...
def create_block(
    ...
    if layer_idx not in attn_layer_idx:
        ...
        mixer_cls = partial(
            ...
            layer_idx=layer_idx,
            n_vars=n_vars, VPT_mode=VPT_mode,
            **ssm_cfg,
            **factory_kwargs
        )
    else:
...
class MixerModel(nn.Module):
    ...
    def forward(self, x, inference_params=None, **mixer_kwargs):
        ...
        for layer in self.layers:
            # hidden_states, residual, dt, B, C = layer(hidden_states, residual, inference_params=inference_params, **mixer_kwargs)
